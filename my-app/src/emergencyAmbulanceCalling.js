...
const EmergencyAmbulanceCalling = ({ onClose, emergencyRequest }) => {
  // State variables
  ...
  // Emergency details configuration
  ...
  // Enable UI components based on steps
  useEffect(() => {
  ...
  return (
    <Dialog open fullScreen TransitionComponent={Fade} BackdropComponent={Backdrop}>
      <Box sx={{
        height: '100%',
        display: 'flex',
